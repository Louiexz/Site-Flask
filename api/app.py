...
def handle_message(data):
    ...
    username = usuarios_conectados.get(sender_sid, f'Anonymous{contador_anonymous}')[username_slice_start:username_slice_end]
...
def handle_connect():
    ...
    username = f'Anonymous{contador_anonymous}'
